...
os.chdir(r'/home/student/Документы/PycharmProjects/IS-22/Engibaryan/PZ-11')
files = [f for f in os.listdir() if os.path.isfile(f)]
print("Список файлов в PZ_11:")
for file in files:
    print(file)
...
pdf_file = r'/home/student/Документы/PycharmProjects/IS-22/Engibaryan/PZ-16/PZ-16.pdf'
